...
from agents.pulmonologist.prompts.analysis import ROLE_DEFINITION, ANALYSIS_INSTRUCTION
from agents.pulmonologist.prompts.summary import SUMMARY_INSTRUCTION
from llm.client import llm_client
import json

class PulmonologistAgent(BaseAgent):
    def __init__(self):
        super().__init__(role_name="Pulmonologist")
